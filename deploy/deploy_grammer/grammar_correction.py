...
class GrammarCorrector():
    ...
    def __init__(self):
        ...
        # to load the model
        self.tokenizer = AutoTokenizer.from_pretrained("addy88/t5-grammar-correction", cache_dir='pretrained_models')
        self.model = AutoModelForSeq2SeqLM.from_pretrained("addy88/t5-grammar-correction", cache_dir='pretrained_models')
