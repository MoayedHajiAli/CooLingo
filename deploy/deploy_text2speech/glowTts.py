...
class GlowTts:
    def __init__(self, device=None):
        ...
        # load model state
        model, _ = load_checkpoint(model, TTS_MODEL, use_cuda= self.device == 'cuda')
        self.model = model
        self.model.eval()
    ...
    def generate_voice(self, sentence: str, length_scale=1.0, noise_scale=0.33, use_cuda=False, enable_figures=False):
